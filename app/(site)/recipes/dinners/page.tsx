...
export const metadata: Metadata = {
  title: "Dinner Recipes | Grown",
  description: "Main courses worthy of a dinner party. THC-infused recipes for elevated entertaining.",
};

export default function DinnersPage() {
  const recipes = getRecipesByCategory("dinners");
  ...
  return (
    <div className="py-12 md:py-20">
      ...
      <nav className="mb-8 text-sm text-[#2C3628]/60">
        ...
        <span className="text-[#2C3628]">Dinners</span>
      </nav>

      {/* Header */}
      <div className="mb-12">
        <h1 className="serif text-4xl text-[#2C3628] md:text-5xl">Dinners</h1>
        <p className="mt-4 text-lg text-[#2C3628]/70">
          Main courses worthy of a dinner party.
        </p>
      </div>
      ...
      {recipes.length > 0 ? (
        ...
        <div className="rounded-[24px] border border-[#2C3628]/10 bg-white/50 p-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-md text-[#2C3628]/60">
            We&apos;re testing dinner recipes. Join the waitlist to be notified.
          </p>
      ...
      <section className="mt-16">
        ...
        <div className="flex flex-wrap gap-3">
          <Link href="/recipes/snacks-sides" className="rounded-full border border-[#2C3628]/20 px-4 py-2 text-sm text-[#2C3628] hover:bg-[#2C3628]/5">
            Snacks & Sides
          </Link>
