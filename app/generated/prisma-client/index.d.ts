...
export namespace Prisma {
  ...
  */
  ...
  interface SubscriberFieldRefs {
    ...
    readonly interests: FieldRef<"Subscriber", 'String'>
    readonly zip: FieldRef<"Subscriber", 'String'>
  ...
  export type SubscriberWhereInput = {
    ...
    interests?: StringFilter<"Subscriber"> | string
    zip?: StringNullableFilter<"Subscriber"> | string | null
  ...
  export type SubscriberScalarWhereWithAggregatesInput = {
    ...
    interests?: StringWithAggregatesFilter<"Subscriber"> | string
    zip?: StringNullableWithAggregatesFilter<"Subscriber"> | string | null
